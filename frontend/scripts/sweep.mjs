...
for (const theme of ['dark','light']) {
  ...
  for (const [name,path] of [['portfolio','/portfolio'],['research','/research'],['screener','/screener'],['screener-all','/screener?view=all'],['screener-stocks','/screener?tab=stocks'],['profile','/profile'],['goals','/goals'],['goal-new','/goals/new'],...(seed ? [['goal',`/goals/${seed.id}`]] : []),['login','/login']]) {
