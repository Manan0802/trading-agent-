...
for (const theme of ['dark','light']) {
  ...
  for (const [name,path] of [['portfolio','/portfolio'],['holdings','/portfolio/holdings'],['research','/research'],['decide','/decide'],['screener','/screener'],['screener-all','/screener?view=all'],['screener-stocks','/screener?tab=stocks'],['screener-basket','/screener?tab=basket'],['fund','/screener/fund/122639'],['stock','/screener/stock/HDFCBANK.NS'],['profile','/profile'],['goals','/goals'],['goal-new','/goals/new'],...(seed ? [['goal',`/goals/${seed.id}`]] : []),['login','/login']]) {
